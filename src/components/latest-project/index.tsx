...
export default function LatestProject(props: LatestProjectProps) {
  return (
    <section
      {...props}
      style={{ background: "linear-gradient(0deg, #479CFF, #47B5FF)" }}
      ...
      <div className="flex flex-col items-center md:items-start md:gap-[60px] md:w-[350px] md:mr-[45px]">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <h1 className="text-white text-center md:text-left px-[20%] md:px-0">
            Tempo, an Open Source Weather App built with React Native
          </h1>
          <p className="hidden md:block text-white/70">
            Tempo is an open source weather app built with React Native. It
            delivers accurate weather information with a user-friendly
            interface.
          </p>
          <a href="/Tempo" target="_blank">
            <Button className="my-[25px]">Discover Tempo</Button>
          </a>
        </div>
      </div>
